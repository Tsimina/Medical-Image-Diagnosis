# train_deffensive_distilation.py
...
# ---------------------------------------------------------
def get_loaders():
    # De obicei pentru distillation folosim doar transformări deterministe
    ...
    train_ds = datasets.ImageFolder(f"{DATA_DIR}/train", transform=eval_tf)
...
def main():
    ...
    # 3) student = model de distillation
