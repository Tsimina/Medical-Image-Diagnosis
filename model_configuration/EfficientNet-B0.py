...
data_path = "C:/Users/simin/OneDrive/Desktop/Master_an_2/IA3/lab/chest_xray"
train_ds = datasets.ImageFolder(f"{data_path}/train", transform=train_tf)
val_ds   = datasets.ImageFolder(f"{data_path}/val", transform=eval_tf)
test_ds  = datasets.ImageFolder(f"{data_path}/test", transform=eval_tf)
